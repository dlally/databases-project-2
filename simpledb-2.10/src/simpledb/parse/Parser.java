...
//  Method for parsing create index commands
    ...
    public CreateIndexData createIndex() {
        String sidxType = lex.eatId(); // Added support for specifying index type
        // Match the index type against the enum, default to static hash when unknown
        IndexType idxType = IndexType.sh;
        if(sidxType.equalsIgnoreCase("bt")){
            idxType = IndexType.bt;
        }
        else if(sidxType.equalsIgnoreCase("eh")){
            idxType = IndexType.eh;
        }
