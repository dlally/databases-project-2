...
public class IndexUpdatePlanner implements UpdatePlanner {
    ...
    public int executeCreateIndex(CreateIndexData data, Transaction tx, IndexType idxtype) {
        SimpleDB.mdMgr().createIndex(data.indexName(), data.tableName(), data.fieldName(), tx, idxtype);
        return 0;
    }
