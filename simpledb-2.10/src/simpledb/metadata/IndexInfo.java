...
public class IndexInfo {
     ...
     */
    public IndexInfo(String idxname, IndexType indexType, String tblname, String fldname,
                     Transaction tx) {
    ...
    public Index open() {
        ...
        if(idxtype == IndexType.bt){
            return new BTreeIndex(idxname, sch, tx);
        }
        else if(idxtype == IndexType.eh){
            return new ExtensibleHashIndex(idxname, sch, tx);
        }
        //Default to creating a hash index
