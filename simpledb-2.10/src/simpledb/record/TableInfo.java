...
public class TableInfo {
    ...
    public int offset(String fldname) {
        if(offsets.get(fldname) == null){
            System.err.println("offset is null");
        }
    ...
    /**
     * CS4432
     * Returns the sorted status flag for the table.
    ...
    /**
     * CS4432
     * Sets the sorted status flag for the table.
     * @param isSorted the sorted status flag.
     */
    public void setSorted(boolean isSorted) {
        this.isSorted = isSorted;
        //System.out.println("Table " + tblname + " sorted status = " + isSorted + ".\n");
    }
}